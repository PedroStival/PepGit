<template>
    ...
    <div class="row g-6 g-xl-9 mb-6 mb-xl-9 mt-3">
      <KTFolder v-for="capitulo in capitulos" :key="capitulo.id" :folder-name="`Capítulo ${capitulo.numero}`" :quantidade="capitulo.quantidadeArquivos" type="capitulo" :id="capitulo.id" :empresaId="empresaId"></KTFolder>
