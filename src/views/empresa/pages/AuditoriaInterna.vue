...
<div class="card">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <!--begin::Table-->
        <div class="panel bg-light mb-3" style="border-radius: 10px" v-for="capitulo in capitulos" :key="capitulo.numero">
            <h2 class="p-3">{{capitulo.numero}} - {{capitulo.titulo}}</h2>
            <div class="w-100 p-2">
            <table class="table align-middle gs-0 bg-white border" style="border-radius:10px" v-for="item in capitulo.items" :key="item.numero">
                <!--begin::Table head-->
                <thead>
                    <tr class="fw-bolder text-muted">
                        <th class="ps-4 min-w-300px">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{item.capitulo}}.{{item.numero}} - {{item.titulo}}</span>
                        ...
                        <td colspan="2">
                            <div class="p-2 w-100">
                                <table class="table align-middle gs-0 border">
                                    ...
                                    <tbody>
                                        <tr v-for="pergunta in item.auditoriaInterna" :key="pergunta.id">
                                            <td class="ps-4">
                ...
                <tfoot>
                    <tr>
                        <td class="ps-4 w-100 d-flex justify-content-end"><button class="btn btn-primary me-3">Salvar</button></td>
                    </tr>
                </tfoot>
                <!--end::Table body-->
            </table>
